...
(function($){
    ...
    var CarouselEvo = function(element, options){
        ...
        var slideItems = carousel.children('.slideItem'),
            slideImage = slideItems.find('img .bg-image'),
            currentSlide = 0,
            targetSlide = 0,
        ...
        this.init = function(){
            ...
            initSlides();
               hideDesc(currentSlide-1); 
               hideDesc(currentSlide+1); 
               hideMain(currentSlide-1); 
               hideMain(currentSlide+1); 
        ...
        var animateSlide = function(){
            ...
            showMain(currentSlide); 
            showMain(currentSlide-1); 
            showMain(currentSlide+1);
             hideDesc(currentSlide-1); 
               hideDesc(currentSlide+1);         
            //animation    
            ...
            for (var i=0; i < n; i++){
                ...
                $('<div class="reflection"></div>')
                    .css({'position':'absolute', 'margin':'0', 'padding':'0', 'border':'none', 'overflow':'hidden', 'left':'0', 
                        'top':setImageSize(i).height+'px', 'width':'100%', 'height':'100%'})
                    .appendTo(items.eq(i))
     ...
     el.append('<div class="buttonNav"></div>');
          ...
          for (var i = 0; i < n; i++){
               var arr = [ "Health Sciences", "Human Services", "Agriscience", "Arts Communication ", "Engineering Manufacturing", "Business Marketing","Career Planning"  ];

          jQuery.each(arr, function() {
              $('<div class="'+buttonName+'">'+this+'</div>')
        ...
        var hideDesc = function(index){
            ...
            if (o.description == true){
                ...
                desc.children('div').eq(index).fadeOut("slow").delay(800);
        ...
        var hideMain = function(index){
              $('.bg-image').eq(index).show();
              $('.main').eq(index).hide();
              //$('.main').show();
               
        };
        var showMain = function(index){
              $('.bg-image').eq(index).hide();
              $('.main').eq(index).show();
              //$('.main').show();
